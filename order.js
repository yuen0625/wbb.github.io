...
function loadfunction(){
    ...
    if(food_type == 1){
        ...
        document.getElementById('productimg').src = "picture/黑糖咖啡.jpg";
        document.getElementById('productPrice').innerHTML = "$100";
    }
    if(food_type == 2){
        document.getElementById('productTitle').innerHTML = "拿鐵咖啡";
        document.getElementById('productimg').src = "picture/拿鐵咖啡.jpg";
        document.getElementById('productPrice').innerHTML = "$100";
    }
    if(food_type == 3){
        document.getElementById('productTitle').innerHTML = "巧克力蛋糕";
        document.getElementById('productimg').src = "picture/巧克力蛋糕.jpg";
        document.getElementById('productPrice').innerHTML = "$90";
    }
    if(food_type == 4){
        document.getElementById('productTitle').innerHTML = "卡布奇諾";
        document.getElementById('productimg').src = "picture/卡布奇諾.jpg";
        document.getElementById('productPrice').innerHTML = "$100";
    }
    if(food_type == 5){
        document.getElementById('productTitle').innerHTML = "義式濃縮咖啡";
        document.getElementById('productimg').src = "picture/義式濃縮.jpg";
        document.getElementById('productPrice').innerHTML = "$100";
    }
    if(food_type == 6){
        document.getElementById('productTitle').innerHTML = "草莓慕斯杯";
        document.getElementById('productimg').src = "picture/草莓慕斯杯.jpg";
        document.getElementById('productPrice').innerHTML = "$95";
    }
    if(food_type == 7){
        document.getElementById('productTitle').innerHTML = "起司幕斯草莓";
        document.getElementById('productimg').src = "picture/起司幕斯草莓.jpg";
        document.getElementById('productPrice').innerHTML = "$100";
    }
}
...
function storeData(){
    ...
    if(food_type == 6)localStorage.setItem('草莓慕斯杯',qty);
    if(food_type == 7)localStorage.setItem('起司幕斯草莓',qty);
}
...
a[5] = localStorage.getItem('草莓慕斯杯');
a[6] = localStorage.getItem('起司幕斯草莓');
...
function tablePicture(i){
    if(i==0)return "<img src='picture/黑糖咖啡.jpg' class='bitPic'>";
    else if(i==1)return"<img src='picture/拿鐵咖啡.jpg' class='bitPic'>";
    else if(i==2)return"<img src='picture/巧克力蛋糕.jpg'>";
    else if(i==3)return"<img src='picture/卡布奇諾.jpg' class='bitPic'>";
    else if(i==4)return"<img src='picture/義式濃縮.jpg' class='bitPic'>";
    else if(i==5)return"<img src='picture/草莓慕斯杯' class='bitPic'>";
    else if(i==6)return"<img src='picture/起司幕斯草莓 ' class='bitPic'>";
}
...
function tableName(i){
    ...
    else if(i==5) return "草莓慕斯杯";
    else if(i==6) return "起司幕斯草莓";　
}
